...
<body class="cnt-home">
	...
	<div class="body-content outer-top-xs" id="top-banner-and-menu">
						...
						<div id="hero" class="homepage-slider3">
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								<div class="full-width-slider">
									<div class="item" style="background-image: url(assets/images/sliders/home1.png);">
										<!-- /.container-fluid -->
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->

								<div class="full-width-slider">
									<div class="item full-width-slider" style="background-image: url(assets/images/sliders/homef.png);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
								...
								<div class="row">
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">free ship-on oder over Taka. 60.00</h6>
										</div>
									</div><!-- .col -->
											...
											<div class="row product-micro-row">
												...
												<div class="col col-xs-6">
													<div class="product-info">
														...
														<div class="product-price">
															<span class="price">
															Taka. <?php echo htmlentities($row['productPrice']); ?>
															</span>
		...
		<script src="//code.tidio.co/bmqyntsqcziv8to2r3gycbkec8fu0u4c.js"></script>
